...
var API_v2_0 = require('./API_v2_0.js');

// Private Functions
function __verifyVersion(version) {
    if ( version != '1.0' && version != '1.1' && version != '1.2' && version != '2.0' ) {
        throw new Error("Unrecognized version specified.  Supported versions are: '1.0', '1.1', '1.2', '2.0'");
    }
}
